...
- Added `force_reload` option to `Dataset` and `InMemoryDataset` to reload datasets ([#8352](https://github.com/pyg-team/pytorch_geometric/pull- Resolved issue with outdated `protobuf` version causing compatibility problems ([#4719](https://github.com/pyg-team/pytorch_geometric/pull/4719))8352), [#8357](https://github.com/pyg-team/pytorch_geometric/pull/8357))
