...
from torch_geometric.data import import torch
import os
import re
from torch_geometric.data import Data, InMemoryDataset
from torch_geometric.utils import download_url, extract_gz
...
class MoleculeNet(InMemoryDataset):
    ...
    def process(self):
        ...
        for line in dataset:
            ...
            # Assume `from_smiles` is a function that processes SMILES data
    ...
    def __repr__(self) -> str:
        return f'{self.names[self.name][0]}({len(self)})'s MoleculeNet(InMemoryDataset):
